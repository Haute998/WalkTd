    ...
    MobileArea.prototype = {
        ...
        bindEvent: function() {
            ...
            function areaCtrlInit() {
                _self.gearArea.querySelector(".area_province").setAttribute("val", _self.value[0] == "" ? 1 : _self.value[0]);
                _self.gearArea.querySelector(".area_city").setAttribute("val", _self.value[1] == "" ? 13 : _self.value[1]);
                _self.gearArea.querySelector(".area_county").setAttribute("val", _self.value[2] == "" ? 3 : _self.value[2]);
