...
if (themeSelector) {
    ...
    function selectChange(value){
        ...
        if (theme != 'default') {
            ...
            require(['~/layout/lib/echarts/2.2.7/doc/example/theme/' + theme], function (tarTheme) {
                curTheme = tarTheme;
...
if (developMode) {
        ...
        function loadedListener() {
            ...
            require.config({
                packages: [
                    {
                        name: 'echarts',
                        location: '~/layout/lib/echarts/2.2.7/src',
                        main: 'echarts'
                    },
                    {
                        name: 'zrender',
    ...
    require.config({
        paths: {
            echarts: '../layout/lib/echarts/2.2.7/doc/example/www/js'
        }
    });
    launchExample();
}
...
function launchExample() {
    ...
    require(
        [
            'echarts',
            'layout/lib/echarts/2.2.7/doc/example/theme/' + hash.replace('-en', ''),
            'echarts/chart/line',
            'echarts/chart/bar',
